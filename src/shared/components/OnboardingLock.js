    ...
    const handleMobileSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                if (tuitionsError) console.warn("Legacy sync warning (tuitions):", tuitionsError.message);
            } catch (e) { console.warn("Legacy sync failed (tuitions table not found)"); }
            ...
            try {
                ...
                if (requestsError) console.warn("Legacy sync warning (tuition_requests):", requestsError.message);
            } catch (e) { console.warn("Legacy sync failed (tuition_requests table not found)"); }
            ...
            try {
                ...
                if (leadError) console.warn("Lead sync warning:", leadError.message);
            } catch(e) { console.warn("Lead sync failed (leads table not found)"); }
            ...
            console.log("Profile update call completed. Awaiting refresh...");
            alert("Phone number submitted! Refreshing your session...");
            onComplete();

        } catch (error) {
            console.error("Critical error during mobile sync:", error);
