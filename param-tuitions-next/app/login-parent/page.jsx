  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      window.location.href =
        `https://app.paramtuitions.com/parent/dashboard#access_token=${access_token}&refresh_token=${refresh_token}&token_type=bearer`;
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-slate-800 to-slate-900 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mt-3 font-poppins">Parent Login</h1>
          <p className="text-slate-400 text-sm mt-1">Sign in to track your child's tuition</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-xs text-slate-500">
              Are you a teacher?{' '}
              <Link href="/login-teacher" className="text-[#0f172a] font-semibold hover:underline">
                Teacher Login
              </Link>
            </p>
